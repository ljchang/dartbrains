...
def _(mo):
    mo.md(r"""
    > **Interactive version:** [Open this notebook in molab](https://molab.marimo.io/github/ljchang/dartbrains/blob/v2-marimo-migration/content/RSA.py) to run code, interact with widgets, and modify examples.
    """)
    return
...
def _(beta, mask_x):
    out = []
    for _m in mask_x:
        out.append(beta.apply_mask(_m).distance(metric='correlation'))
    return (out,)
...
@app.cell
def _(out, roi):
    _f = out[roi].plot_mds(n_components=3, view=(20, 10))
    return
