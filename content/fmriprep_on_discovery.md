...
fmriprep is an fMRI data preprocessing pipeline that is discussed throughout the course in the [preprocessing](Preprocessing.ipynb) and [download data](Download_Data.ipynb) tutorials.
